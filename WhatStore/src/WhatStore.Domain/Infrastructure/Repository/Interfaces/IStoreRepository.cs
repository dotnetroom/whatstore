...
namespace WhatStore.Domain.Infrastructure.Repository.Interfaces
{
    ...
    {
        Task<bool> UpdateStoreInformation(ICollection<IFormFile> Pictures, long userID, string storeName, string storeDescription, string phoneNumber, string email, string URL,
